...
namespace cms {
  namespace kokkos {
    ...
    public:
      ...
      explicit ScopedContextAcquire(edm::WaitingTaskWithArenaHolder holder,
                                    ContextState<ExecSpace>& contextState) : waitingTaskHolder_(std::move(holder)), contextState_(&contextState) {}
      ...
      explicit ScopedContextAcquire(const ProductBase& data, edm::WaitingTaskWithArenaHolder holder,
        ...
        : impl::ScopedContextGetterBase<ExecSpace>(data), waitingTaskHolder_(std::move(holder)), contextState_(&contextState) {}
    ...
    public:
      ...
      explicit ScopedContextProduce(ContextState<ExecSpace>& contextState) : impl::ScopedContextGetterBase<ExecSpace>(contextState.release()) {}
