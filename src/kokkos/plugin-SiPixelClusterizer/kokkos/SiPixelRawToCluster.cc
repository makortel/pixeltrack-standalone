...
namespace KOKKOS_NAMESPACE {
  ...
  private:
    void acquire(edm::Event const& iEvent, const edm::EventSetup& iSetup, edm::WaitingTaskWithArenaHolder waitingTaskHolder) override;
  ...
  void SiPixelRawToCluster::acquire(edm::Event const& iEvent, const edm::EventSetup& iSetup, edm::WaitingTaskWithArenaHolder waitingTaskHolder) {
